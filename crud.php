...
<html lang="en">
	...
	<body >
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12" align="center">
					<h1 class="teksheader" style="margin-top:0px;">
			...
			<div class="container">		
				...
				<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
					...
					<div class="navbar-nav ">
						<a class="nav-item nav-link active" href="#pclub">Profile Club </a>
						<a class="nav-item nav-link" href="crud_player.php">Profile Player</a>
						<!--Button
		...
		<div class="container" id="pclub">
			<div class="row">
				<div class="col-md-12" >					
					<a href="form_tambah.php" class=" btn btn-primary" style="text-decoration:none;background-color: #17467C !important;">
						Tambah
					</a>
					<table class="table table-hover" action="ubah.php" method="post">
						...
						<?php
							$no = 1;
							$data = mysqli_query($con,"select * from club");
						...
						?>
								<tr>
									...
									<td>  <?= $row['manager'];?></td>	
									<td>
											 <a href="ubah.php?id=<?= $row['id']; ?>" class="btn btn-success btn-sn" 
											 	style="text-decoration:none;background-color: #17467C !important;">Ubah</a>   
